 ...
 * @version $Revision: 7 $
 */
public class WindowClassificationPerformanceEvaluator2 extends AbstractOptionHandler
    ...
    public Measurement[] getPerformanceMeasurements() {
    	...
    	try {
            return new Measurement[]{ new Measurement("classified instances",this.TotalweightObserved), new Measurement("classifications correct (percent)", getFractionCorrectlyClassified() * 100.0), new Measurement("Kappa Statistic (percent)", getKappaStatistic() * 100.0)};    		

		} catch (NullPointerException e) {
    		return new Measurement[]{ new Measurement("classified instances", 0), new Measurement("classifications correct (percent)", 0), new Measurement("Kappa Statistic (percent)", 0)};
		}
